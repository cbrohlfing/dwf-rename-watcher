...
# Version: v1.8 (lock + housekeeping + status)
#
# Folder layout (versioned):
#   C:\Scripts\v1.6\Rename-IdwDwf-Watcher-Tray.ps1
#   C:\Scripts\v1.6\dwf_rename_settings.json
#   C:\Scripts\v1.6\dwf_rename_watcher.log
#
# Features:
